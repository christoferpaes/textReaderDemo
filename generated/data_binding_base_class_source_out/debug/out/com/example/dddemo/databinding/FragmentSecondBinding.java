...
package com.example.dddemo.databinding;
...
public final class FragmentSecondBinding implements ViewBinding {
  ...
  private FragmentSecondBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonMedium,
  ...
  public static FragmentSecondBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.button_medium;
      Button buttonMedium = rootView.findViewById(id);
      ...
      return new FragmentSecondBinding((ConstraintLayout) rootView, buttonMedium, buttonSecond,
          textviewSecond);
    }
